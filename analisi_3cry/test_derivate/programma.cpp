...
for (int i=0; i<righe; i++)
	{
		def[i].x=res[i].x+(smax)*(segno*s.eigenvectors().col(modo)[3*i])/(sqrt(s.eigenvalues()[modo]));	
		def[i].y=res[i].y+(smax)*(segno*s.eigenvectors().col(modo)[3*i+1])/(sqrt(s.eigenvalues()[modo]));
		def[i].z=res[i].z+(smax)*(segno*s.eigenvectors().col(modo)[3*i+2])/(sqrt(s.eigenvalues()[modo]));
	}
...
for (int l=0; l<200; l++)
{
	for (int i=0; i<righe; i++)
	{
		def[i].x=res[i].x+(ss.at(l))*(segno*s.eigenvectors().col(modo)[3*i])/(sqrt(s.eigenvalues()[modo]));	
		def[i].y=res[i].y+(ss.at(l))*(segno*s.eigenvectors().col(modo)[3*i+1])/(sqrt(s.eigenvalues()[modo]));
		def[i].z=res[i].z+(ss.at(l))*(segno*s.eigenvectors().col(modo)[3*i+2])/(sqrt(s.eigenvalues()[modo]));
	}
...
for (int i=0; i<100; i++)
{
	deltadelta.at(i)=deltamin+i*(deltamax-deltamin)/100;
}
...
for (int i=0; i<righe; i++) //Deformo con s=+delta
	{
		def[i].x=res[i].x+(deltadelta.at(h))*(segno*s.eigenvectors().col(modo)[3*i])/(sqrt(s.eigenvalues()[modo]));	
		def[i].y=res[i].y+(deltadelta.at(h))*(segno*s.eigenvectors().col(modo)[3*i+1])/(sqrt(s.eigenvalues()[modo]));
		def[i].z=res[i].z+(deltadelta.at(h))*(segno*s.eigenvectors().col(modo)[3*i+2])/(sqrt(s.eigenvalues()[modo]));
	}
...
dGa=(Gap-Gam)/(2*(deltadelta.at(h)));
dGb=(Gbp-Gbm)/(2*(deltadelta.at(h)));
d2Ga=(Gap+Gam-2*Ga0)/((deltadelta.at(h))*(deltadelta.at(h)));
d2Gb=(Gbp+Gbm-2*Gb0)/((deltadelta.at(h))*(deltadelta.at(h)));

cout << deltadelta.at(h) << " " << dGa/Ga0 <<  " " << dGb/Gb0 << " " << d2Ga/Ga0 << " " << d2Gb/Gb0 << endl;
}
...
b=segno*(s.eigenvectors().col(modo)[3*51]-s.eigenvectors().col(modo)[3*122])/(sqrt(s.eigenvalues()[modo]));
d=segno*(s.eigenvectors().col(modo)[3*51+1]-s.eigenvectors().col(modo)[3*122+1])/(sqrt(s.eigenvalues()[modo]));
e=segno*(s.eigenvectors().col(modo)[3*51+2]-s.eigenvectors().col(modo)[3*122+2])/(sqrt(s.eigenvalues()[modo]));
...
b=segno*(s.eigenvectors().col(modo)[3*10]-s.eigenvectors().col(modo)[3*50])/(sqrt(s.eigenvalues()[modo]));
d=segno*(s.eigenvectors().col(modo)[3*10+1]-s.eigenvectors().col(modo)[3*50+1])/(sqrt(s.eigenvalues()[modo]));
e=segno*(s.eigenvectors().col(modo)[3*10+2]-s.eigenvectors().col(modo)[3*50+2])/(sqrt(s.eigenvalues()[modo]));
