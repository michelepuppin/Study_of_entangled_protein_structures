...
//Sommo sui k tralasciando i primi sei autovalori PARZIALE
vector<double> deltaRiparz(righe);

for(int i=0; i<(righe); i++)
{
	for(int k=6; k<26; k++)
		{
		deltaRiparz.at(i)+=deltaRik[i][k];
		}
}
...
if (fileout4.is_open())
{
	for (int i=0; i<righe; i++)
	{
		fileout4 << i << " " << (area1/area2)*(deltaRi.at(i)) << " " << (area1/area3)*(deltaRiparz.at(i)) << endl;
	}
}
else 
{
...
d2Gb=(Gbp+Gam-2*Gb0)/(delta*delta);

cout << "dG (1-50) = " << dGa << endl;
cout << "dG (10-50) = " << dGb << endl;
cout << "d2G (1-50) = " << d2Ga << endl;
cout << "d2G (10-50) = " << d2Gb << endl;
...
a=res[51].x-res[112].x;
c=res[51].y-res[112].y;
f=res[51].z-res[112].z;
...
cout << "dd (51-112) = " << (a*b+c*d+e*f)/(sqrt(a*a+c*c+e*e)) << endl;
cout << "d2d (51-112) = " << (b*b+d*d+f*f)/(sqrt(a*a+c*c+e*e))-((a*b+c*d+e*f)*(a*b+c*d+e*f))/(pow(a*a+c*c+e*e,3/2)) << endl;
...
cout << "dd (10-50) = " << (a*b+c*d+e*f)/(sqrt(a*a+c*c+e*e)) << endl;
cout << "d2d (10-50) = " << (b*b+d*d+f*f)/(sqrt(a*a+c*c+e*e))-((a*b+c*d+e*f)*(a*b+c*d+e*f))/(pow(a*a+c*c+e*e,3/2)) << endl;
