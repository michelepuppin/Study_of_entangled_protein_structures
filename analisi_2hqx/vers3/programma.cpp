...
pippo=sqrt(pow(res[21].x-res[50].x,2)+pow(res[21].y-res[50].y,2)+pow(res[21].z-res[50].z,2));
pluto=sqrt(pow(def[21].x-def[50].x,2)+pow(def[21].y-def[50].y,2)+pow(def[21].z-def[50].z,2));
...
cout << "Distanza 50-21 " << 100*(abs(pippo-pluto))/pippo << endl;
